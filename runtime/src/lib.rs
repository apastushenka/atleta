...
// WTF: autogenerated pallet indexes, see
// https://docs.rs/pallet-scheduler/latest/pallet_scheduler/#warning
// https://substrate.stackexchange.com/questions/1163/whats-the-logic-behind-polkadots-choice-in-pallet-indexing
construct_runtime!(
    pub enum Runtime {
        System: frame_system,
